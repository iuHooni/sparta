...
dart = OpenDartReader('ad4964c40dbf0cb38e7523bdde9daca7d03de6fc')

# # == 1. 공시정보 검색 ==
# # 삼성전자의 정기보고서('A') 2019년
# print(dart.list('005930', kind='A', start='2019-01-01', end='2019-12-31'))
...
# # ==== 3. 상장기업 재무정보 ====
# # 삼성전자 2018 재무제표 
# print(dart.finstate('삼성전자', 2018)) #~ 사업보고서

# # 삼성전자 2018Q1 재무제표
print(dart.finstate('삼성전자', 2020, reprt_code='99626'))
...
# # ==== 5. 확장 기능 ====
# # 지정한 날짜의 공시목록 전체
# print(dart.list_date('2020-01-03'))
